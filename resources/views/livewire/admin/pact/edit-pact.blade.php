    ...
    <div class="row p-2 mt-2">
        ...
        <div class="col-md-8 offset-md-3 offset-sm-1 p-2 col-sm-10 ">
            <a href="{{ route('admin.dashboard.pacts') }}" class="btn btn-warning">
                ...
                {{ __('words.back') }}</a>
            <div class="card mt-2">
                <div class="card-header">{{ __('words.addpact') }}
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit.prevent='update'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group my-2">
                                        <div wire:ignore>
                                            <label for="select2Eidt">Users</label><span class="text-danger">*</span>
                                    ...
                                    <div class="english-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_type" type="text" id="en_type">
                                            @error('en_type')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_model"  id="en_model">
                                            @error('en_model')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_accessoar" type="text" id="en_accessoar">
                                            @error('en_accessoar')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_noteOne" type="text" id="en_noteOne">
                                            @error('en_noteOne')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_noteTwo"  id="en_noteTwo">
                                            @error('en_noteTwo')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="en_status" id="en_status">
                                            @error('en_status')
                                                <div class="text-danger fs-6">
                                    ...
                                    <div class="arabic-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="ar_type" type="text" id="ar_type">
                                            @error('ar_type')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="ar_model"  id="ar_model">
                                            @error('ar_model')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            <label for="ar_accessoar ">الأكسسوارات</label><span class="text-danger">*</span>
                                            <input
                                                class="form-control @error('ar_accessoar') border-danger border-2  @enderror"
                                                wire:model.lazy="ar_accessoar" type="text" id="ar_accessoar">
                                            @error('ar_accessoar')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="ar_noteOne" type="text" id="ar_noteOne">
                                            @error('ar_noteOne')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="ar_noteTwo"  id="ar_noteTwo">
                                            @error('ar_noteTwo')
                                                <div class="text-danger fs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                wire:model.lazy="ar_status"  id="ar_status">
                                            @error('ar_status')
                                                <div class="text-danger fs-6">
                        ...
                        <div class="form-group my-2">
                            <input type="submit" class="btn btn-primary" value="{{ __('words.editPact') }}">
                        </div>
